...
public class SeataTxController {
    ...
    public Boolean placeOrderRollback() {
        Product data = Product.builder()
                ...
                .build();
        log.info("data={}", data);
        R<Product> save = this.productApi.save(data);
        log.info("a={}", save);
