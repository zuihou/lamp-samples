package top.tangyh.lamp.example.config.datasource;
...
@MapperScan(
        ...
        sqlSessionFactoryRef = ExampleDatabaseAutoConfiguration.DATABASE_PREFIX + "SqlSessionFactory")
@EnableConfigurationProperties({MybatisPlusProperties.class})
@ConditionalOnExpression("!'DATASOURCE'.equals('${lamp.database.multiTenantType}')")
public class ExampleDatabaseAutoConfiguration extends BaseMasterDatabaseConfiguration {

    public ExampleDatabaseAutoConfiguration(MybatisPlusProperties properties,
